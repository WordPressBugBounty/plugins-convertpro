        ...
        <div class="wd-dr-modal" id="<?php echo esc_attr($this->client->slug); ?>-wd-dr-modal">
            <div class="wd-dr-modal-wrap">
                <div class="wd-dr-modal-header">
                    <h3>
                        <?php $this->client->_etrans('If you have a moment, please let us know why you are deactivating:'); ?>
                    </h3>
                </div>
                        ...
                        <?php foreach ($reasons as $reason) { ?>
                            <li data-type="<?php echo esc_attr($reason['type']); ?>"
                                ...
                                <label><input type="radio" name="selected-reason" value="<?php echo esc_attr($reason['id']); ?>">
                                    <?php echo esc_attr($reason['text']); ?></label>
                            </li>
                        <?php } ?>
                    </ul>
                    <p class="wd-dr-modal-reasons-bottom">
                        We never share your data to any third party. This data will help us to troubleshoot the problems and
                        make product improvements. Learn more about how WPGrids handles your data
                ...
                <div class="wd-dr-modal-footer">
                    <a href="#" class="dont-bother-me">
                        <?php $this->client->_etrans("I rather wouldn't say"); ?>
                    </a>
                    <button class="button-secondary">
                        <?php $this->client->_etrans('Submit & Deactivate'); ?>
                    </button>
                    <button class="button-primary">
                        <?php $this->client->_etrans('Cancel'); ?>
                    </button>
                </div>
            </div>
        </div>
